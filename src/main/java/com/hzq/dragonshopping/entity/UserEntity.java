...
public class UserEntity {
    ...
    public UserEntity(Integer user_id, String user_name, String user_sex, String user_password, String user_address, String user_phone, String user_headimgurl, Integer user_status, Integer user_type, Double user_money, String user_email, String user_uname) {
        this.user_id = user_id;
        this.user_name = user_name;
        this.user_sex = user_sex;
        this.user_password = user_password;
