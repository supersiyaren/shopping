...
public class SendmailUtil2 {
    ...
    public static String myEmailAccount = "460021749@qq.com";
    public static String myEmailPassword = "ejprshridvgfbhbc";//这个密码不是QQ密码或者邮箱密码，要验证的。自己百度
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "1710031565@qq.com";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        // 4. Subject: 邮件主题
        message.setSubject("商城", "UTF-8");

        // 设置邮件的内容体
        message.setContent("你的商品已发货", "text/html;charset=UTF-8");
        /*
         * 下面是邮件内容的创建:
         */
...
//        message.setContent(mm);
    ...
    public static void sendMall(String qq) throws Exception {
        // 1. 创建参数配置, 用于连接邮件服务器的参数配置
        Properties props = new Properties();                    // 参数配置
        props.setProperty("mail.transport.protocol", "smtp");   // 使用的协议（JavaMail规范要求）
        props.setProperty("mail.smtp.host", myEmailSMTPHost);   // 发件人的邮箱的 SMTP 服务器地址
        ...
        // 3. 创建一封邮件
        MimeMessage message = createMimeMessage(session, myEmailAccount, qq);
